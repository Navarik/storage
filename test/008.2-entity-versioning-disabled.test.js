...
const run = config => {
  ...
  describe(`Entity versioning disabled, index type [${config.index.description || config.index}]`, () => {
    ...
    it('requests for specific versions are rejected', forAll(fixtures, (fixture, index) => async () => {
      try {
