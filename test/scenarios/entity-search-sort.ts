...
const fixturesTasks: Array<CanonicalEntity<any, any>> = require('../fixtures/data/data-entry-tasks.json')
...
export const entitySearchSort = (createStorage: <T extends object = {}>(config: StorageConfig<T>) => Storage<T>) => {
