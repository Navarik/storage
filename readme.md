...
- `index.entityTransform: Function` - apply transformation to the entity before it is saved to the **index**.  Note that transformation is not applied to entity going to the changelog.
